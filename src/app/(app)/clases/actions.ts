...
// ─────────────────────────────────────────────────────────────
// Academias: ya NO se registran desde aquí (22-sep-2026)
// ─────────────────────────────────────────────────────────────
// `prepararAcademia` y `materializarAcademia` se borraron con el botón del
// modal. La programación de academia es la misma todas las semanas, así que
// `/cierre` la deriva del planeador (`academia_pendientes`) y la fila de
// `clases` nace al cerrarla (`clase_abrir_del_planeador`). Dejar aquí una
// segunda puerta habría sido justo lo que este proyecto ya pagó varias veces:
// dos caminos para lo mismo, y nadie sabe cuál es el bueno.
